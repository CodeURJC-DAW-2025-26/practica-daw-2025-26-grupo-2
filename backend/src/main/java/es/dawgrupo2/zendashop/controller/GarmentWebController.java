...
@Controller
public class GarmentWebController {
	...
	public String newGarment(Model model, Garment garment, MultipartFile imageField, HttpServletRequest request) {
	...
	public String editGarmentProcess(Model model, Garment editedGarment, @PathVariable long id,
		MultipartFile imageField, @RequestParam(name = "updateImage", defaultValue = "false") boolean updateImage, HttpServletRequest request) {
		Optional<Garment> op = garmentService.findById(id);
