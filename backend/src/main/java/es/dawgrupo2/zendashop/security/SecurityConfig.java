...
public class SecurityConfig {
    ...
    public SecurityFilterChain restFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorize -> authorize
            // Public Access
            .requestMatchers(HttpMethod.GET,  "/api/v1/garments/", "/api/v1/garments/*", "/api/v1/garments/*/opinions/", "/api/v1/garments/*/opinions/*", "/api/v1/images/*", "/api/v1/images/*/media").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/v1/auth/login", "/api/v1/auth/refresh", "/api/v1/users/").permitAll()
                
            // Users Access
            .requestMatchers(HttpMethod.GET, "/api/v1/users/me/orders", "/api/v1/users/me", "/api/v1/users/me/cart",  "/api/v1/users/*", "/api/v1/users/*/cart", "/api/v1/users/*/orders", "/api/v1/orders/*/orderItems/", "/api/v1/orders/*/orderItems/*", "/api/v1/orders/*", "/api/v1/orders/*/invoice", "/api/v1/statistics/users/*", "/api/v1/garments/offers").hasAnyRole("USER", "ADMIN")
